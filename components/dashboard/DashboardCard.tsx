...
function DashboardCard({
  ...
  return (
    <div className={cn("bg-[#161B22] border border-zinc-800/60 p-4 sm:p-6 desktop:p-8 h-fit text-white relative overflow-hidden shadow-xl shadow-black/25 animate-[fadeInScale_0.6s_ease-out_0.1s_both]", className)}>
